...
<section id = 'cocina'>
        ...
        <div class = 'contenedor-rest'>
            ...
            <section id="detalles-rest">
                <div id="desc-rest">
                    ...
                    <p>Aquí, los comensales pueden deleitarse con platos caseros preparados con amor y cuidado, como el clásico arroz con guandú, tamales, carimañolas y ropa vieja, entre otros. Este acogedor establecimiento es un reflejo de la rica herencia culinaria panameña, donde los sabores locales se mezclan en un festín de delicias que evocan la historia y la cultura del país.
                    </p>
                    <br><hr><br>
    ...
    <div id="ofertas">
        ...
        <section id = 'distribucion'>
            ...
            <div class = 'contenedor-restaurante'>
                <img src="img/Sancocho.jpg" alt = 'Imagen de Sancocho'>
                    <div class = 'local'>
                        <strong><p>Sancocho</p></strong>
                        <strong><p>$7.00</p></strong>
                    </div>
                    <div class = 'atributos'>
                        <h4 id="nombreRest">Ingredientes:</h4>
                        <p id="ingredientes">Pollo, yuca, ñame, maíz, cebolla, ají, culantro, ajo, sal y pimienta.</p>
                    </div>         
            </div>
            <div class = 'contenedor-restaurante'>
